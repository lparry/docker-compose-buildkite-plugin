...
On a system with `envsubst`, that tool will be used instead of `eval`, and this variable can be used to define the environment variable allowlist so unexpected interpolations are disallowed.
